...
<section class="bg-light py-5" id="contact">
            <div class="container px-5 my-5 px-5">
                <div class="text-center mb-5">
                    ...
                    <p class="lead mb-0"> Télécharger votre CV et votre lettre de motivation sous format PDF</p>
                 </div>
                    ...
                    <div class="formulaire">
                       ...
                       <form    method="POST" action="" enctype="multipart/form-data">  
                            ...
                            <div class="form-floating mb-3">
                                <!--le cv -->
                                <input class="form-control" id="name" type="file" name= "fichier" />
                                <input class="bouton2" id="name" type="submit" name="uploadBtn" value="Envoyer votre fichier" /><br/>
